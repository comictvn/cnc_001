<?php
namespace Theloaitin\Form;
use Zend\Form\Element;
use Zend\Form\Form;
class TheloaitinForm extends Form{

    public function __construct($name=null)
    {
        parent::__construct('theloaitin');
        ...
        $name_en = new Element\Text('name_en');
        $name_en->setAttributes(array('class'=>'validate[required]'));
        $this->add($name_en);
