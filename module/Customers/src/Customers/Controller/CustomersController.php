    ...
    public function addAction()
    {
    	...
    	if($request->isPost())
    	{
    		...
    		if($form->isValid())
    		{
															...
															<td width="600">
																...
																<table width="100%"
																	...
																	<tbody>
																		<tr>
																			<td width="4%"></td>
																			<td width="558" align="left"><strong>Chào' . $_POST['customers_name'] . '
																			,</strong></td>
																			<td width="25"></td>
																		</tr>
																		<tr>
    			...
    			$smtpOptions->setHost('smtp-mail.outlook.com')
    			->setConnectionClass('login')
    			->setName('smtp-mail.outlook.com')
    			->setConnectionConfig(array(
    					'username'=>'seo1@dongphucviet.com',
    			...
    			try {
    				$transport->send($mail);
    				$giohang->huygiohang();
    				return $this->redirect()->toRoute('customers',array('action'=>'print','id'=>$customers_id));
    				exit();
    			}
    			catch (Exception $e)
