  ...
  , labelOff: " Không có VAT "
	 ...
	 /* Multiselect */
         ...
         if($("#fmultiselect").length > 0){
            $("#fmultiselect").multiSelect({
                selectableHeader: "<div class='multipleselect-header'>Chọn danh mục sản phẩm</div>",
                selectedHeader: "<div class='multipleselect-header'>Danh mục được chọn</div>"
            });
		 ...
		 if($("#multiselect1").length > 0){
            $("#multiselect1").multiSelect();
         }
         if($("#fmultiselect1").length > 0){
            $("#fmultiselect1").multiSelect({
                selectableHeader: "<div class='multipleselect-header'>Chọn liên hệ</div>",
                selectedHeader: "<div class='multipleselect-header'>Liên hệ được chọn</div>"
            });
            $('#multiselect-selectAll1').click(function(){
                $('#fmultiselect1').multiSelect('select_all');
                return false;
            });
            $('#multiselect-deselectAll1').click(function(){
                $('#fmultiselect1').multiSelect('deselect_all');
                return false;
            });
            $('#multiselect-selectIndia1').click(function(){
                $('#fmultiselect1').multiSelect('select', 'in');
                return false;
            });         
         }
    // SELECT2       
   ...
   // TOOLTIPSborder:{
        ...
        // SELECTABLE
         ...
         {
            $("#tSortable").dataTable({"iDisplayLength": 10, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null, null, null, null, null]});
